...
if(isset($_REQUEST["game_id"]))
{
    if(isset($_REQUEST["vote_id"]))
    {
        ...
        if(mysqli_query($con,$sql))
        {
            ...
            $sql = "INSERT INTO tm (game_id,mode,mode_details,max_player,tm_period_id,tm_end_register,lan_id) VALUES ('$game_id','$mode','$mode_details','$max_player','$tm_period_id','$end_register','0')";
            if(mysqli_query($con,$sql))
            {
